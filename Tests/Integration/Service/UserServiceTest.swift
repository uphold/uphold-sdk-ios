...
class UserServiceTest: XCTestCase {
    ...
    func testCreateContactShouldReturnTheRequest() {
        ...
        XCTAssertEqual(request.url, "https://api.uphold.com/v0/me/contacts",  "Failed: Wrong URL.")
    ...
    func testGetUserShouldReturnTheRequest() {
        ...
        XCTAssertEqual(request.url, "https://api.uphold.com/v0/me", "Failed: Wrong URL.")
    ...
    func testGetUserPhonesShouldReturnTheRequest() {
        ...
        XCTAssertEqual(request.url, "https://api.uphold.com/v0/me/phones", "Failed: Wrong URL.")
        XCTAssertEqual(request.method, "GET", "Failed: Wrong method.")
    }
    ...
    func testGetUserTransactionsShouldReturnTheRequest() {
        ...
        XCTAssertEqual(request.url, "https://api.uphold.com/v0/me/transactions", "Failed: Wrong URL.")
        XCTAssertEqual(request.method, "GET", "Failed: Wrong method.")
