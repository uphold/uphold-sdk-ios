...
public class Origin: Mappable {
    ...
    */
    public init(accountId: String, cardId: String, accountType: String, amount: String, base: String, commission: String, currency: String, description: String, fee: String, node: Node, rate: String, sources: [Source], type: String, username: String) {
